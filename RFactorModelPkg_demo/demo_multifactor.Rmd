...
wgts <- c(0.2,0.2,0.15,0.05,0.15,0.3)
...
mTSF1 <- factor_orthogon_single(mTSF,y='F_NP_chg_w13',x = 'NP_YOY',sectorAttr = NULL)
#multiple factors orthogonal
mTSF2 <- factor_orthogon(mTSF,forder=c("ln_mkt_cap_","PB_mrq_","pct_chg_per_60_","NP_YOY","F_NP_chg_w13","pio_f_score"),sectorAttr = NULL)

```

### 正交处理后相关性图
```{r mforthogoncorr,echo=TRUE,eval=TRUE,fig.height=5,fig.width=6}
MF.chart.Fct_corr(mTSF2)
```
